...
test('Z-articles Offset: none', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker(),
        dp = input.data('datepicker'),
    ...
    equal(dp.o.zIndexOffset, 10, 'Z-articles offset option defaults to 10.');
    equal(picker.css('z-index'), 244, 'Picker Z-articles offset is respected.');
});

test('Z-articles Offset: with value', function(){
    var input = $('<input />')
            .appendTo('#qunit-fixture')
            .datepicker({
                zIndexOffset: 1000
    ...
    equal(dp.o.zIndexOffset, 1000, 'Z-articles offset option is accepted.');
    equal(picker.css('z-index'), 1234, 'Picker Z-articles offset is respected.');
});
